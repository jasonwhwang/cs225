...
gradientColorPicker::gradientColorPicker(RGBAPixel fadeColor1,
                    ...
                    :color1(fadeColor1), color2(fadeColor2), rad(radius), cx(centerX), cy(centerY)
{ }
...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
    ...
    if(distance > rad) { return color2; }
    else{
        color.red = color1.red + color2.red*distance/rad - color1.red*distance/rad;
        color.green = color1.green + color2.green*distance/rad - color1.green*distance/rad;
        color.blue = color1.blue + color2.blue*distance/rad - color1.blue*distance/rad;
        return color;
    }
}
